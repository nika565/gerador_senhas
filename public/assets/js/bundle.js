...
function exibir() {
  ...
  var qtdCarac = document.querySelector('.quantidade-caracteres');
  var maiusculos = document.querySelector('.add-maiusculas');
  var minusculos = document.querySelector('.add-minusculas');
  var numeros = document.querySelector('.add-numeros');
  var simbolos = document.querySelector('.add-simbolos');
  var btnGerar = document.querySelector('.gerar-senha');
  var saida = document.querySelector('.senha-gerada');
  btnGerar.addEventListener('click', function () {
    saida.innerHTML = (0,_geradores__WEBPACK_IMPORTED_MODULE_0__.geraSenha)(Number(qtdCarac.value), maiusculos.checked, minusculos.checked, numeros.checked, simbolos.checked);
  });
}
...
var alfaMinusculo = 'abcdefghijklmnopqrstuvwxyz';
var alfaMaiusculo = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ';
var numerosSenha = '1234567890';
var simbolosSenha = '!@#$%&*()-_+={}[]^~:;|?';
function geraSenha(qtd, maiusculo, minusculo, numeros, simbolos) {
  var arrSenha = [];
  for (var i = 0; i < qtd; i++) {
    if (maiusculo === true) {
...
.senha-gerada {
    font-size: 2em;
    margin-top: 20px;
}`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAAA;IACI,SAAS;IACT,UAAU;IACV,sBAAsB;AAC1B;;AAEA;IACI,yBAAyB;IACzB,yCAAyC;IACzC,iBAAiB;AACrB;;AAEA;IACI,UAAU;IACV,0BAA0B;IAC1B,aAAa;IACb,mBAAmB;IACnB,uBAAuB;AAC3B;;AAEA;IACI,eAAe;IACf,iBAAiB;AACrB;;AAEA;IACI,WAAW;IACX,YAAY;IACZ,kBAAkB;AACtB;;AAEA;IACI,WAAW;IACX,YAAY;IACZ,iBAAiB;AACrB;;;AAGA;IACI,cAAc;IACd,yBAAyB;IACzB,cAAc;IACd,YAAY;IACZ,yBAAyB;IACzB,YAAY;IACZ,kBAAkB;IAClB,eAAe;AACnB;;AAEA;IACI,cAAc;IACd,gBAAgB;AACpB","sourcesContent":["*{\r\n    margin: 0;\r\n    padding: 0;\r\n    box-sizing: border-box;\r\n}\r\n\r\nbody{\r\n    background-color: #142D63;\r\n    font-family: Arial, Helvetica, sans-serif;\r\n    min-height: 110vh;\r\n}\r\n\r\n.section{\r\n    width: 50%;\r\n    margin: 50px auto 0px auto;\r\n    padding: 30px;\r\n    border-radius: 10px;\r\n    background-color: white;\r\n}\r\n\r\nlabel{\r\n    font-size: 22px;\r\n    font-weight: bold;\r\n}\r\n\r\ninput[type='checkbox']{\r\n    width: 15px;\r\n    height: 15px;\r\n    padding-left: 10px;\r\n}\r\n\r\ninput[type='number']{\r\n    width: 50px;\r\n    height: 30px;\r\n    padding-left: 5px;\r\n}\r\n\r\n\r\nbutton{\r\n    display: block;\r\n    margin: 50px 0px 30px 0px;\r\n    font-size: 2em;\r\n    padding: 5px;\r\n    background-color: #142D63;\r\n    color: white;\r\n    border-radius: 5px;\r\n    cursor: pointer;\r\n}\r\n\r\n.senha-gerada {\r\n    font-size: 2em;\r\n    margin-top: 20px;\r\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _modules_exibir__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/exibir */ "./src/modules/exibir.js");
...
// Usar os recursos mais recente do JS em navegadores mais antigos



//import modulos do javascript

(0,_modules_exibir__WEBPACK_IMPORTED_MODULE_2__.exibir)();
